...
This project proposes a modular, open-source, and self-hosted alternative to proprietary AI platforms. The architecture is designed to support enterprise-grade AI agents, Retrieval-Augmented Generation (RAG), workflow automation, Model Context Protocol (MCP) integrations, and hybrid AI deployments using both Azure AI services and locally hosted language models.
